...
//        View certificateView = certificate.inflateCertificateView(mContext);
        View certificateView = RefMirror.on(certificate).call("inflateCertificateView",mContext).get();
        final LinearLayout placeholder =
                (LinearLayout) certificateView.findViewById(MR.get("id","placeholder"));
...
//            successString.setText(com.android.internal.R.string.ssl_certificate_is_valid);
            successString.setText(MR.get("string","ssl_certificate_is_valid"));
        } else {
...
//                .setTitle(com.android.internal.R.string.ssl_certificate)
                .setTitle(MR.get("string","ssl_certificate"))
                .setIcon(iconId)
