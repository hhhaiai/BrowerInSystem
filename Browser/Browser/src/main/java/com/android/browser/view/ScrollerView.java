...
import com.android.browser.util.MR;
...
//    private StrictMode.Span mFlingStrictSpan = null;
    ...
    private Object mScrollStrictSpan = null;  // aka "drag"
    ...
    public ScrollerView(Context context, AttributeSet attrs) {
        this(context, attrs, MR.get("attr", "scrollViewStyle"));
    }
...
//        TypedArray a =
//                context.obtainStyledAttributes(attrs, MR.getArray("styleable", "styleable"), defStyle, 0);
//        setFillViewport(a.getBoolean(MR.get("styleable", "ScrollView_fillViewport"), false));
//        a.recycle();
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (yDiff > mTouchSlop) {
                    ...
                    if (mScrollStrictSpan == null) {
                        mScrollStrictSpan = RefMirror.on("android.os.StrictMode").call("enterCriticalSpan", "ScrollView-scroll").get();
...
//                        mFlingStrictSpan.finish();
                        RefMirror.on(mFlingStrictSpan).call("finish").get();
                ...
                case MotionEvent.ACTION_SCROLL: {
                    if (!mIsBeingDragged) {
                        if (mHorizontal) {
                            ...
                            if (hscroll != 0) {
                                float t = RefMirror.on((View) this).call("getHorizontalScrollFactor").get();
                                final int delta = (int) (hscroll * t);
                                final int range = getScrollRange();
                            ...
                            if (vscroll != 0) {
                                ...
                                if (newScrollY != oldScrollY) {
                                    super.scrollTo(getScrollY(), newScrollY);
                                    return true;
                                }
                            }
                        }
    ...
    protected void onOverScrolled(int scrollX, int scrollY,
        ...
        if (!mScroller.isFinished()) {
            setScaleX(scrollX);
            setScaleY(scrollY);
            RefMirror.on(this).call("invalidateParentIfNeeded").get();
...
//            mScrollStrictSpan.finish();
            RefMirror.on(mScrollStrictSpan).call("finish").get();
...
//                mFlingStrictSpan = StrictMode.enterCriticalSpan("ScrollView-fling");
                mFlingStrictSpan = RefMirror.on(StrictMode.class).call("enterCriticalSpan", "ScrollView-fling").get();
            }
