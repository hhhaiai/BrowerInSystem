 ...
 */
public class NavTabScroller1 extends ScrollerView {
    ...
    public NavTabScroller1(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }
    public NavTabScroller1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NavTabScroller1(Context context) {
        super(context);
        init(context);
    }
    ...
    static class ContentLayout extends LinearLayout {
        ...
        NavTabScroller1 mScroller;

        public ContentLayout(Context context, NavTabScroller1 scroller) {
            super(context);
            mScroller = scroller;
        }
