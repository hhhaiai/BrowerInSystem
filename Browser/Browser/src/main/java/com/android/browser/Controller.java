...
//        send.putExtra(Browser.EXTRA_SHARE_FAVICON, favicon);
    ...
    static Bitmap createScreenshot(WebView view, int width, int height) {
        int w = RefMirror.on(view).call("getContentWidth").get();
        ...
        int contentWidth = RefMirror.on(view).call("getContentWidth").get();
...
//        WebView.disablePlatformNotifications();
        RefMirror.on(WebView.class).call("disablePlatformNotifications").get();
...
//        WebView.enablePlatformNotifications();
        RefMirror.on(WebView.class).call("enablePlatformNotifications").get();
        ...
        AsyncTask<Void, Void, String[]> task =
                new AsyncTask<Void, Void, String[]>() {
                    ...
                    public String[] doInBackground(Void... unused) {
                        ...
                        String[] r = RefMirror.on("android.provider.Browser").call("getVisitedHistory", mActivity.getContentResolver()).get();
                        return r;
                    }
    ...
    public void onReceivedHttpAuthRequest(Tab tab, WebView view,
        ...
        if (username != null && password != null) {
            ...
            boolean isOk = RefMirror.on(handler).call("suppressDialog").get();
            if (tab.inForeground() && !isOk) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.dump_nav_menu_id:
                RefMirror.on(getCurrentTopWebView()).call("debugDump").get();
//                getCurrentTopWebView().debugDump();
    ...
    public Intent createBookmarkCurrentPageIntent(boolean editExisting) {
        ...
        String touchIconUrl = RefMirror.on(w).call("getTouchIconUrl").get();
