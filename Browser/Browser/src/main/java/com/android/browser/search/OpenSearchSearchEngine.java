...
//                byte[] responseBytes = Streams.readFully(urlConnection.getInputStream());
                ...
                Charset responseCharset =   RefMirror.on("libcore.net.http.ResponseUtils").call("responseCharset",urlConnection.getContentType()).get();
                if (responseCharset==null){
                    return null;
                }
                byte[] responseBytes = RefMirror.on("libcore.io.Streams").call("readFully",urlConnection.getInputStream()).get();
