...
import io.github.mthli.Ninja.utils.RefMirror;
...
//        webSettings.setAppCachePath(context.getCacheDir().toString());
        RefMirror.on(webSettings).call("setAppCacheEnabled",true).get();
        RefMirror.on(webSettings).call("setAppCachePath",context.getCacheDir().toString()).get();
