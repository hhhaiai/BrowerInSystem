...
public class Browser {
     ...
     * identifier.
     */
    public static final String EXTRA_APPLICATION_ID = "com.android.browser2.application_id";
    /**
     ...
     * <p>
     */
    public static final String EXTRA_HEADERS = "com.android.browser2.headers";
    ...
    public static final void sendString(Context context, String string) {
        //@ update by sanbo
        //https://www.androidos.net.cn/android/6.0.1_r16/xref/frameworks/base/core/res/res/values-zh-rCN/strings.xml
        //<string name="sendText" msgid="5209874571959469142">"选择要对文字执行的操作"</string>
        sendString(context, string, "选择要对文字执行的操作");
    }
